        ...
        <div className="bg-indigo-500 p-4 flex justify-between">
          <div className="flex items-center gap-3">
            <div className="relative bg-gray-400 text-2xl text-white grid place-content-center w-12 h-12 rounded-full">
              S<span className="w-4 h-4 border-2 border-indigo-600 rounded-full bg-green-200 absolute bottom-0 right-0"></span>
            </div>
            <div>
          ...
          <button className="outline-none text-white h-14 w-14 hover:bg-indigo-800 grid place-content-center transition-all duration-300 rounded-lg">
            <XIcon />
          </button>
        </div>
        ...
        {loading ? (
          ...
          <div className="m-5">
            <div className="border rounded-lg focus-within:border-indigo-600 transition-all duration-300 overflow-hidden flex items-end">
              ...
              />
              <Paperclip className="text-gray-400 mb-4 mr-4" />
            </div>
            <p className="mt-3 text-center text-sm text-gray-400">
              Chatbot powered by <span className="text-indigo-700 hover:underline">Kommunicate.io</span>
            </p>
          </div>
        )}
      </PopoverContent>
